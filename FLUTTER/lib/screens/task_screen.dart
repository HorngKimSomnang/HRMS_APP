...
class _TaskScreenState extends State<TaskScreen> with LiveRefreshMixin<TaskScreen> {
        ...
        child: Wrap(
          children: [
            Padding(
              ...
              child: Text(
                AppLocalizations.of(context)!.attachProof,
            ...
            ListTile(
              ...
              title: Text(
                AppLocalizations.of(context)!.choosePhotoFromGallery,
                style: GoogleFonts.notoSansKhmer(),
              ),
              onTap: () async {
                final file = await ImagePicker().pickImage(
            ...
            ListTile(
              ...
              title: Text(
                AppLocalizations.of(context)!.chooseVideoFromGallery,
                style: GoogleFonts.notoSansKhmer(),
              ),
              onTap: () async {
                final file = await ImagePicker().pickVideo(
  ...
  Future<void> _toggleStatus(dynamic task) async {
          ...
          builder: (ctx) => AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                child: Text(AppLocalizations.of(context)!.attachMedia),
              ),
            ],
          ),
        );
    ...
    try {
      await _taskService.updateTaskWithSubmission(
        task['id'],
        newStatus,
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (task['attachment_path'] != null ||
                    ...
                    if (task['attachment_path'] != null)
                      ListTile(
                        ...
                        title: Text(
                          AppLocalizations.of(context)!.adminInstructions,
                          style: GoogleFonts.notoSansKhmer(
                            fontSize: 14,
                    ...
                    if (task['submission_path'] != null)
                      Padding(
                        ...
                        child: ListTile(
                          ...
                          tileColor: Colors.green.shade50.withValues(
                            alpha: 0.5,
                          ),
                          leading: const Icon(
                            LucideIcons.image,
                          ...
                          title: Text(
                            AppLocalizations.of(context)!.yourSubmission,
                            style: GoogleFonts.notoSansKhmer(
                              fontSize: 14,
                  ...
                  if (task['submission_note'] != null &&
                      (task['submission_note'] as String).isNotEmpty) ...[
                    const SizedBox(height: 16),
                    Text(
                      AppLocalizations.of(context)!.submissionNote,
                      style: GoogleFonts.notoSansKhmer(
                        fontSize: 14,
                        fontWeight: FontWeight.bold,
                      ),
                  ...
                  if (localSheetFilePath == null)
                    OutlinedButton.icon(
                      ...
                      label: Text(
                        isCompleted
                            ? AppLocalizations.of(context)!.changeProofFile
                            : AppLocalizations.of(
                                context,
                              )!.attachPhotoOrVideoProof,
                      ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              AppLocalizations.of(context)!.proofAttachedReady,
                              style: GoogleFonts.notoSansKhmer(
                                color: Colors.green.shade700,
                                fontSize: 13,
                              ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            (isCompleted && localSheetFilePath == null)
                            ? Colors.grey
                            : Colors.blue,
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(12),
                      ...
                      child: Text(
                        (isCompleted && localSheetFilePath == null)
                            ...
                            : (isCompleted && localSheetFilePath != null)
                            ? AppLocalizations.of(context)!.saveNewProof
  ...
  Widget build(BuildContext context) {
    ...
    final completedTasks = _tasks
        .where((task) => task['status'] == 'completed')
        .toList();
    final visibleTasks = _taskView == 'active' ? activeTasks : completedTasks;
          ...
          Container(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: _buildTaskViewButton(
                      label: AppLocalizations.of(context)!.activeBadge,
                  ...
                  Expanded(
                    child: _buildTaskViewButton(
                      label: AppLocalizations.of(context)!.completedLabel,
            ...
            child: Skeletonizer(
              ...
              child: _error != null && !_loading
                  ...
                  : RefreshIndicator(
                      ...
                      child: (visibleTasks.isEmpty && !_loading)
                          ? ListView(
                              children: [
                          ...
                          : ListView.builder(
                              itemCount: _loading ? 3 : visibleTasks.length,
  ...
  Widget _buildTaskViewButton({
    required String label,
    required int count,
    required String value,
    required Color color,
  }) {
    final isSelected = _taskView == value;

    return Material(
      color: isSelected ? Colors.white : Colors.transparent,
      borderRadius: BorderRadius.circular(10),
      child: InkWell(
        onTap: () => setState(() => _taskView = value),
        borderRadius: BorderRadius.circular(10),
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: color.withValues(alpha: isSelected ? 0.12 : 0.07),
                  borderRadius: BorderRadius.circular(10),
                ),
                child: Text(
                  '$count',
